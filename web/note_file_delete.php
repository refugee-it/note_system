 ...
 */
/**
 * @file $/web/note_file_delete.php
 * @brief Unattach a file from a note.
...
$note = GetNoteById($fileInfo['id_note']);
...
require_once(getLanguageFile("note_file_delete"));
...
if (!(isset($_POST['confirm']) === true))
{
    echo "        <div>\n".
         ...
         "          <form action=\"note_file_delete.php?id=".htmlspecialchars($fileId, ENT_COMPAT | ENT_HTML401, "UTF-8")."\" method=\"post\">\n".
         "            <fieldset>\n".
...
{
    $deleteSuccess = NoteRemoveUpload($fileId);
    ...
    if ($deleteSuccess === 0)
    {
        echo "        <p>\n".
             ...
             "        </p>\n".
             "        <a href=\"note_details.php?id=".htmlspecialchars($noteId, ENT_COMPAT | ENT_HTML401, "UTF-8")."\">".LANG_DONE."</a>\n";
    }
    else
    {
        echo "        <p>\n".
