...
define("LANG_STEP0_INTROTEXT", "Sie sind dabei, dieses kleine und einfache Notiz-System zu installieren. Das Notiz-System ist <a href=\"http://de.wikipedia.org/wiki/Freie_Software\">freie Software</a> gemäß der <a href=\"http://www.gnu.org/philosophy/free-sw.de.html\">Definition</a> der <a href=\"http://www.fsf.org/\">Free Software Foundation</a> (Freie-Software-Stiftung, siehe auch die europäische <a href=\"http://www.fsfe.org\">Free Software Foundation Europe</a>) infolge der Lizenzierung unter der GNU Affero General Public License 3 oder jeder späteren Version dieser Lizenz. Im nächsten Schritt des Installationsvorgangs wird der vollständige Lizenztext angezeigt, welchem Sie zustimmen, sobald Sie die Software verwenden. Ein kurzer Überblick über die eingeräumten Nutzungsrechte: ".
                               ...
                               "  <li>Falls Sie auf einen Fehler in der Software stoßen oder zusätzliche Features wünschen, können Sie eine Issue dafür im primären Repository (sofern vorhanden, momentan kann <a href=\"https://github.com/refugeei-it/note_system/issues\">dieser Ort</a> als das Issue-System des primären Repositorys betrachtet werden) anlegen oder die Autoren kontaktieren, wenn Sie die Änderungen selbst entweder nicht durchführen wollen oder können. Wenn Sie die Änderungen selbst vornehmen, wäre es nett von Ihnen, uns eine Benachrichtigung über die vorgenommenen Änderungen zukommen zu lassen.</li>".
                               "</ul>".
                               "Features der Software: ".
                               "<ul>".
                               "  <li>Anlegen von Personen</li>".
                               "  <li>Erfassen von Notizen zu Personen</li>".
