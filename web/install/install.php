    ...
    if (isset($_POST['init']) === true)
    {
        ...
        if (Database::Get()->IsConnected() === true)
        {
            ...
            if ($success === true)
            {
                if ($dropExistingTables === true)
                {
                    if (Database::Get()->ExecuteUnsecure("DROP TABLE IF EXISTS `".Database::Get()->GetPrefix()."persons`") !== true)
                    {
                        $success = false;
                    }
                }
            ...
            if ($success === true)
            {
                ...
                $sql .= "`".Database::Get()->GetPrefix()."persons` (".
                        "  `id` int(11) NOT NULL AUTO_INCREMENT,".
                        "  `family_name` varchar(255) COLLATE utf8_bin NOT NULL,".
                        "  `given_name` varchar(255) COLLATE utf8_bin NOT NULL,".
                        "  `date_of_birth` date,".
            ...
            if ($success === true)
            {
                if ($dropExistingTables === true)
                {
                    if (Database::Get()->ExecuteUnsecure("DROP TABLE IF EXISTS `".Database::Get()->GetPrefix()."notes`") !== true)
                    {
                        $success = false;
                    }
                }
